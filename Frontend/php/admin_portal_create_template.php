            ...
            <form class="needs-validation" method="POST">
                ...
                <div class="row mx-0">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="templateName" name="templateName" placeholder="Enter Template Name" value="" required>
                    ...
                    <div class="col-lg-auto">
                        ...
                        <button type="submit" name="submit_template" value="Save Template" class="btn btn-primary"><i class="bi bi-check-circle-fill pe-2"></i>Save Template</button>
                    </div>
                </div>
                            ...
                            <div class="table-responsive">
                                <table id="templateFieldTable" class="table table-hover" data-toggle="table"
                                    ...
                                    <tbody class="connected-sortable droppable-area1">
                                        <tr class="draggable-item">
                                            ...
                                            <!-- <td><span class="js-sort-number">1</span>
                                              ...
                                              <!-- Data field selection -->
                                                <td><select class="form-select" name="type[1]" aria-label="Default select example" required>
                                                ...
                                                <!-- Data field selection -->
                                            <td>
                                                <select class="form-select" name="title[1]" aria-label="Default select example" required>
                                            ...
                                            <td><input type="text" class="form-control" name="placeholder[1]" placeholder="Enter Placeholder" value="" required></td>

                                            <!-- Mandatory field -->
                                            <td><input class="form-check-input mt-0 me-2" name="is_required[1]" type="checkbox" value="1"
                                                    id="flexCheckDefault">
                                        ...
                                        <!-- Data field selection -->
                                        <td><select class="form-select" name="type[2]" aria-label="Default select example" required >
                                            ...
                                            <td>
                                                <select class="form-select" name="title[2]" aria-label="Default select example" required>
                                                    <option value="" selected>Select Field Title</option>
                                                    <option value="Contributor">Contributor</option>
                                                    <option value="Coverage">Coverage</option>
                                                    <option value="Creator">Creator</option>
                                            ...
                                            <td><input type="text" class="form-control" name="placeholder[2]" placeholder="Enter Placeholder" value="" required></td>

                                            <!-- Mandatory field -->
                                            <td><input class="form-check-input mt-0 me-2" name="is_required[2]" type="checkbox" value="1"
                                                    id="flexCheckDefault">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Mandatory field
                                                </label>
                                ...
                                <div class="col-lg-auto">
                                    <!-- <button type="button" class="btn btn-outline-primary me-2"><i class="bi bi-trash3-fill pe-2"></i>Delete Template</button> -->
                                    <button type="submit" name="submit" class="btn btn-primary"><i class="bi bi-check-circle-fill pe-2"></i>Save Fields</button>
                                </div>
                            </div>
                        </div>
