        ...
        <div id="content">
            <?php
                    if(isset($_POST['submit'])){
                        ...
                        foreach ($myfield_values as $myfield_value) {
                            // Sanitize the input to prevent SQL injection
                            $field_type = mysqli_real_escape_string($conn, $field_type);
                            $field_title = mysqli_real_escape_string($conn, $field_title);
                            $field_name = mysqli_real_escape_string($conn, $field_name);
                            $field_required = mysqli_real_escape_string($conn, $field_required);
                            ...
                            // Insert the values into the database
                                $sql = "INSERT INTO `fields`(`type`, `title`, `name`, `placeholder`, `is_required`, `template_id`) VALUES ('$field_type','$field_title','$field_name','','field_required','')";
            ...
            <form class="needs-validation" method="POST">
                ...
                <header id="form-header" class="row mx-0 mb-4 sticky-top">
                    ...
                    <div class="col-lg-auto">
                        ...
                        <button type="submit" name="submit" class="btn btn-primary"><i class="bi bi-check-circle-fill pe-2"></i>Save & Publish</button>
                    </div>
                </header>
                                    ...
                                    <tbody class="connected-sortable droppable-area1">
                                        <tr class="draggable-item">
                                            ...
                                            <!-- <td><span class="js-sort-number">1</span>
                                              ...
                                              <td><select class="form-select" name="type[]" aria-label="Default select example" required>
                                            ...
                                            <td><input type="text" class="form-control" name="title[]" placeholder="Enter Field Title" required></td>

                                            <td><input type="hidden" class="form-control" name="name[]" value="field1" readonly required></td>
                                        ...
                                        <td><select class="form-select" name="type[]" aria-label="Default select example" required >
                                           ...
                                           <td><input type="text" name="title[]" class="form-control" placeholder="Enter Field Title" required></td>
                                            ...
                                            <!-- Mandatory field -->
                                            <td><input class="form-check-input mt-0 me-2" name="is_required[]" type="checkbox" required value="1"
                                                    id="flexCheckDefault">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Mandatory field
                                                </label>
